...
class RenteParObjectif extends StatefulWidget {
  @override
  _RenteParObjectifState createState() => _RenteParObjectifState();
}

class _RenteParObjectifState extends State<RenteParObjectif> {
        ...
        child: Form(
          ...
          child: ListView(
            children: <Widget>[
              ...
              SizedBox(height: 15),
              _buildNumericField('Capital', _capitalController),
              SizedBox(height: 15),
